...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c33ec39a-9e8d-45f6-adae-82ddea7c3b41
```

> `c33ec39a-9e8d-45f6-adae-82ddea7c3b41` is the password of the certificate, you can change it to any password you want.
